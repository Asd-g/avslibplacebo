...
const char* AVSC_CC avisynth_c_plugin_init(AVS_ScriptEnvironment* env)
{
    ...
    avs_add_function(env, "libplacebo_Shader", "cs[width]i[height]i[chroma_loc]i[matrix]i[trc]i[filter]s[radius]f[clamp]f[taper]f[blur]f[param1]f[param2]f[antiring]f[lut_entries]i[cutoff]f[sigmoidize]b[linearize]b[sigmoid_center]f[sigmoid_slope]f[device]i[list_device]b", create_shader, 0);
