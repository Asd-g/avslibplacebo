...
{
    avs_add_function(env, "libplacebo_Deband", "c[iterations]i[threshold]f[radius]f[grainY]f[grainC]f[dither]i[lut_size]i[temporal]b[planes]i*[device]i[list_device]b", create_deband, 0);
